...
public class ZsetRediesTest  extends SpringBootsTest {
    ...
    public void testRangeWithScores() {
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeWithScores = opsForZSet.rangeWithScores("fan6", 0, -1);
    ...
    public void testRangeByScoreWithScores() {
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeByScoreWithScores = opsForZSet.rangeByScoreWithScores("fan8", 1, 2);//注意("fan8",2,1)是获取不到数据的
        ...
        Iterator<ZSetOperations.TypedTuple<Object>> iterator2 = rangeByScoreWithScores2.iterator();
    ...
    public void testReverseRange() {
        ...
        Set<ZSetOperations.TypedTuple<Object>> reverseRangeWithScores = opsForZSet.reverseRangeWithScores("fan9", 0, -1);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator = reverseRangeWithScores.iterator();
        while (iterator.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
			/*
        ...
        Set<ZSetOperations.TypedTuple<Object>> reverseRangeByScoreWithScores = opsForZSet.reverseRangeByScoreWithScores("fan9", -1, 2);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator2 = reverseRangeByScoreWithScores.iterator();
        while (iterator2.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator2.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
			/*
        ...
        Iterator<ZSetOperations.TypedTuple<Object>> iterator3 = reverseRangeByScoreWithScores2.iterator();
    ...
    public void testUnionAndStore() {
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeWithScores = opsForZSet.rangeWithScores("fan16", 0, -1);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator = rangeWithScores.iterator();
        while (iterator.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeWithScores2 = opsForZSet.rangeWithScores("fan18", 0, -1);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator2 = rangeWithScores2.iterator();
        while (iterator2.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator2.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
			/*
    ...
    public void testIntersectAndStore() {
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeWithScores = opsForZSet.rangeWithScores("fan22", 0, -1);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator = rangeWithScores.iterator();
        while (iterator.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
        ...
        Set<ZSetOperations.TypedTuple<Object>> rangeWithScores2 = opsForZSet.rangeWithScores("fan23", 0, -1);
        Iterator<ZSetOperations.TypedTuple<Object>> iterator2 = rangeWithScores2.iterator();
        while (iterator2.hasNext()) {
            ZSetOperations.TypedTuple<Object> next = iterator2.next();
            System.out.println("value:" + next.getValue() + " score:" + next.getScore());
    ...
    public void testScan() {
        ...
        //跟iterator一毛一样，遍历集合
        Cursor<ZSetOperations.TypedTuple<Object>> scan = opsForZSet.scan("fan24", ScanOptions.NONE);
        while (scan.hasNext()) {
    ...
    public void testRangeByLex() {
        ...
        RedisZSetCommands.Range range = RedisZSetCommands.Range.unbounded();
